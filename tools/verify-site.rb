...
%w[en fr].each do |language|
  ...
  check(home.css('script[src$="discord.min.js"]').size == 1, 'Discord widget must initialize once')
  check(home.at_css('#sidebar script[src$="discord.min.js"]'), 'Restore Discord state during sidebar parsing')
